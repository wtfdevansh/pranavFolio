  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-6">
      ...
      <div className="max-w-prose">
        <h2 className="text-2xl font-bold text-accent mb-2">About Devansh Goyal</h2>
        <p className="mb-4">
          Hello! I'm Devansh, a passionate and creative software engineer with a knack for building beautiful, scalable, and user-friendly applications. With a strong foundation in modern web technologies, I specialize in bringing ideas to life from concept to deployment.
        </p>
        <p className="mb-4">
